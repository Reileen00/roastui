...
const container=cva("flex flex-wrap")
...
export function GoodVsBadUI(){
    ...
    <ShowcaseSection 
        ...
        description="Good design is as little design as possible. Bad design is like a bad joke.If you have to explain it, it's no good.">
