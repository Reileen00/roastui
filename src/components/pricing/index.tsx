...
export function Pricing() {
  ...
  return (
    <ShowcaseSection title="Get Started Now" description="Save hours of moving buttons arund and quickly find what's wrong with your designs with RoastUI">
    <div
      className={cn('flex flex-col w-full items-center dark', styles.fancyOverlay)}
    >
            ...
            {tiers.map((tier) => (
              ...
              >
                ...
                <a
                  ...
                  className={cn(
                    'flex mt-6 shadow-sm',
                    tier.soldOut||tier.comingSoon ? 'pointer-events-none' : '',
                  )}
                >
                  <Button
                    size="lg"
